...
export default function Hero() {
  ...
  const typedText = useTypewriter(
    ['Associate Software Engineer', 'Technical Support Agent', 'Clean Code Advocate', 'Enterprise Application Developer', 'Java & Spring Boot Specialist', 'React & TypeScript Developer', 'MERN Stack Experienced', 'Cloud Deployment Troubleshooter', 'Full-Stack Engineer', 'SLIIT IT Graduate', 'Software Architecture Enthusiast', 'Complex Problem Solver'],
    80,
    40,
    2000
  );
