          ...
          <div class="flex flex-wrap">
            <div class="w-full lg:w-1/2">
              ...
              <div class="p-8 pt-0 lg:p-0">
                <p class="mt-6 font-bold">Bsc.(Hons) in Information Technology Specializing in Information Technology - SLIIT</p>
                <p>2021 - Present</p>
                <p class="mt-2 font-bold">Sivali Central College - Ratnapura</p>
                <p>2016 - 2018</p>
                <p class="mt-2 font-bold">Eheliyagoda Central College - Eheliyagoda</p>
                <p>2010 - 2016</p>
              </div>
            </div>
            <div class="w-full lg:w-1/2">
              ...
              <div class="p-8 pt-0 lg:p-0">
                <p class="mt-6 font-bold">BoonFair Technology - Full Stack Developer</p>
                <p>2023 - Present</p>
                <p class="mt-2 font-bold">BoonFair Marketplace - Operations Manager / WordPress Administrator</p>
                <p>2021 - 2022</p>
                <p class="mt-2 font-bold">Trade Finance & Investments PLC - Marketing Junior Executive</p>
                <p>2019 - 2021</p>
              </div>
            </div>
          </div>
